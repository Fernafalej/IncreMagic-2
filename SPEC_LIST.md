# INCREMAGIC — SPEC-Dateien
> Jeder Agent bekommt MASTER + seine relevante SPEC. Nie mehr als nötig.

| SPEC | Spezialist | Inhalt |
|------|-----------|--------|
| `specs/CORE_SPEC.md` | `core-dev` | GameState, Ticker, EventBus, OfflineCalc, SaveManager |
| `specs/RESOURCE_SPEC.md` | `resource-dev` | Ressourcen, Produktionsformel, WorldMana (Sigmoid→Linear) |
...
| `specs/LORE_SPEC.md` | `lore-writer` | Journal, Story-Beats, Ton |
